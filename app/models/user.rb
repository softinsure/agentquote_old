...
class User < ActiveRecord::Base
  ...
  # here.
  attr_accessible :login, :email, :password, :password_confirmation, :first_name, :last_name, :status,
  :middle_name, :reset_password, :group, :agent_code, :effective_at, :expired_at
